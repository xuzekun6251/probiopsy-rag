...
2. 专家先完成**第一部分**：5 个病例各自的推荐动作（五选一）＋选填一句理由。
3. 第一部分收齐或专家自行翻页后，展示**第二部分**（系统 A 输出），填 4 项 Likert 1–5。
...
*Pack generated 2026-09-18 from outputs/demo_cases/*.json (5 cases, verdicts unchanged).*
